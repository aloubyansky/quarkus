...
public class AppModelProcessor {
    ...
    void createAppDeps(BuildProducer<InternalPageBuildItem> menuProducer,
        ...
        page.addPage(Page.webComponentPageBuilder()
                ...
                .componentLink("qwc-app-model.js"));
    ...
    static class Root {
        ...
        public String toString() {
            return "Root{" + "nodes=" + nodes + ", links=" + links + "}";
        }
    ...
    static class Node {
        ...
        @Override
        public String toString() {
            return "Node{" + "id=" + id + ", name=" + name + ", value=" + value + ", description=" + description + "}";
        }
    }
    ...
    static class Link {
        ...
        @Override
        public String toString() {
            return "Link{" + "source=" + source + ", target=" + target + ", type=" + type + "}";
        }
    }
}
