...
public class MultiModuleNamedInjectionDevModeTest extends QuarkusDevGradleTestBase {
    ...
    protected String[] buildArguments() {
        return new String[] {"clean", "quarkusDev", "-s", "-Ddebug=false"};
    }
    ...
    protected void testDevMode() throws Exception {
        ...
        replace("quarkus/src/main/java/org/acme/app/ExampleResource.java", ImmutableMap.of("return \"hello \"", "return \"modified \""));
