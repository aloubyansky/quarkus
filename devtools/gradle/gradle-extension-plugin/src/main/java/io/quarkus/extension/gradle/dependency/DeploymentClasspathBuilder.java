...
public class DeploymentClasspathBuilder {
    ...
    public void exportDeploymentClasspath(String configurationName, LaunchMode mode) {
        ...
        project.getConfigurations().create(deploymentConfigurationName, config -> {
            ...
            DeploymentConfigurationResolver.setDeploymentAndConditionalAttributes(configuration, project, mode);
            ...
            DeploymentConfigurationResolver.setDeploymentAndConditionalAttributes(config, project, mode);
        });
    }
