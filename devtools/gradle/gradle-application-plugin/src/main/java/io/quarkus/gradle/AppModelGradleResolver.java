...
public class AppModelGradleResolver implements AppModelResolver {
    ...
    private io.quarkus.maven.dependency.ResolvedDependency resolveArtifact(
            ArtifactCoords appArtifact) throws AppModelResolverException {
        if (io.quarkus.maven.dependency.ResolvedDependency.class.isAssignableFrom(appArtifact.getClass())) {
            final io.quarkus.maven.dependency.ResolvedDependency resolved = (io.quarkus.maven.dependency.ResolvedDependency) appArtifact;
    ...
    @Override
    public Collection<io.quarkus.maven.dependency.ResolvedDependency> resolveUserDependencies(ArtifactCoords appArtifact,
