...
public interface DependencyFlags {
    ...
    /* @formatter:off */
    int OPTIONAL =                             0b0000000000001;
    int DIRECT =                               0b0000000000010;
    int RUNTIME_CP =                           0b0000000000100;
    int DEPLOYMENT_CP =                        0b0000000001000;
    int RUNTIME_EXTENSION_ARTIFACT =           0b0000000010000;
    int WORKSPACE_MODULE =                     0b0000000100000;
    int RELOADABLE =                           0b0000001000000;
    ...
    int TOP_LEVEL_RUNTIME_EXTENSION_ARTIFACT = 0b0000010000000;
    int CLASSLOADER_PARENT_FIRST             = 0b0000100000000;
    int CLASSLOADER_RUNNER_PARENT_FIRST      = 0b0001000000000;
    int CLASSLOADER_LESSER_PRIORITY          = 0b0010000000000;
     ...
     */
    int COMPILE_ONLY                         = 0b1000000000000;
