...
public class DefaultProjectModule implements ProjectModule, Serializable {

    private final ProjectModuleId id;
    ...
    public DefaultProjectModule(ProjectModuleId id, File moduleDir, File buildDir) {
        super();
        this.id = id;
