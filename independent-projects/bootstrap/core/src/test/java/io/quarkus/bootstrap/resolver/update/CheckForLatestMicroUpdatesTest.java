...
public class CheckForLatestMicroUpdatesTest extends CreatorOutcomeTestBase {
    ...
    protected void initProps(QuarkusBootstrap.Builder builder) {
        builder.setVersionUpdate(VersionUpdate.LATEST)
                .setVersionUpdateNumber(VersionUpdateNumber.MICRO);
    }
    ...
    protected void testCreator(QuarkusBootstrap creator) throws Exception {
        ...
        assertEquals(Arrays.asList(new AppDependency[] {
                new AppDependency(TsArtifact.jar("ext1", "1.0.2").toAppArtifact(), "compile", DependencyFlags.DIRECT,
