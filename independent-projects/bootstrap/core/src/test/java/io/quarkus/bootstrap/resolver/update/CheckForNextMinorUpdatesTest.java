...
public class CheckForNextMinorUpdatesTest extends CreatorOutcomeTestBase {
    ...
    protected void initProps(QuarkusBootstrap.Builder builder) {
        builder.setVersionUpdate(VersionUpdate.NEXT).setVersionUpdateNumber(VersionUpdateNumber.MINOR);
    }
    ...
    protected void testCreator(QuarkusBootstrap creator) throws Exception {
        ...
        assertEquals(Arrays.asList(new AppDependency[] {
                new AppDependency(TsArtifact.jar("ext1", "1.1.0").toAppArtifact(), "compile", DependencyFlags.DIRECT,
