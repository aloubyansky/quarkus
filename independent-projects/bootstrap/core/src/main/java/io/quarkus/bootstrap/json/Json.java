...
public final class Json {
     ...
     * @see JsonBuilder#ignoreEmptyBuilders
     */
    public static JsonArrayBuilder array(boolean ignoreEmptyBuilders, boolean skipEscapeCharacters, int initialCapacity) {
        return new JsonArrayBuilder(ignoreEmptyBuilders, skipEscapeCharacters, initialCapacity);
    }
     ...
     * @see JsonBuilder#ignoreEmptyBuilders
     */
    public static JsonObjectBuilder object(boolean ignoreEmptyBuilders, boolean skipEscapeCharacters, int initialCapacity) {
        return new JsonObjectBuilder(ignoreEmptyBuilders, skipEscapeCharacters, initialCapacity);
    }
