...
class DependencyCollectingSelector implements DependencySelector {

    private final DependencySelector delegate;
    private final ArtifactDependencyMap parent;

    DependencyCollectingSelector(DependencySelector delegate, ArtifactDependencyMap parent) {
    ...
    public DependencySelector deriveChildSelector(DependencyCollectionContext context) {
        ...
        return new DependencyCollectingSelector(derivedChildSelector,
    ...
    public boolean equals(Object o) {
        ...
        DependencyCollectingSelector that = (DependencyCollectingSelector) o;
