...
public class CreateProjectCommandHandler implements QuarkusCommandHandler {
    ...
    public QuarkusCommandOutcome execute(QuarkusCommandInvocation invocation) throws QuarkusCommandException {
        ...
        List<ArtifactCoords> boms = Collections.emptyList();
        ...
        if (ec != null) {
            ...
            final Extension quarkusCore = invocation.getExtensionsCatalog().getExtensions().stream()
            ...
            boms = ElementCatalogBuilder.getBoms(ec, eKeys);
