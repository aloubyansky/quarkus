    ...
    private static class BomUpdateDetails {
        ...
        private void addSteps(UpdateSteps updateSteps) {
            if (configuredBom == null) {
                updateSteps.addStep(new BomImportAddStep(null /* TODO */, registryRecommendedBom));
            } else if (registryRecommendedBom == null) {
                updateSteps.addStep(new BomImportRemoveStep(null /* TODO configuredBom.getConfigurationFile() */,
                ...
                if (newRawGroupId != null || newRawArtifactId != null || newRawVersion != null) {
                    updateSteps.addStep(new BomImportUpdateStep(null /* TODO configuredBom.getConfigurationFile() */,
                            configuredBom.getArtifact().getRawCoords(), ArtifactCoords.pom(
