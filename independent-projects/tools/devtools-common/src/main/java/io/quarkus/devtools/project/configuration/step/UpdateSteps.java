...
public class UpdateSteps {
    ...
    public static void addUpdateSteps(ConfiguredApplication app, RegistryProjectInfo registryProjectInfo,
        ...
        if (specificGroupId != null || specificArtifactId != null || specificVersion != null) {
            ...
            if (specificGroupId != null) {
                System.out.println("  groupId: " + specificGroupId + " -> " + recommendedPlugin.getGroupId() + ", file="
                        + specificGroupId.getResolvedValue().getSource().getPath());
            }
            if (specificArtifactId != null) {
                System.out.println("  artifactId: " + specificArtifactId + " -> " + recommendedPlugin.getArtifactId()
                        + ", file=" + specificArtifactId.getResolvedValue().getSource().getPath());
            }
            if (specificVersion != null) {
                System.out.println("  version: " + specificVersion + " -> " + recommendedPlugin.getVersion() + ", file="
                        + specificVersion.getResolvedValue().getSource().getPath());
            }
        }
    }

    private static ConfiguredValue updatePropertyOrReturnConfiguredValue(UpdateSteps updateSteps, String recommendedValue,
    ...
    private static void addDependencyUpdateSteps(ConfiguredApplication app, RegistryProjectInfo registryProjectInfo,
            UpdateSteps updateSteps) {
