...
public class WorkspaceQuarkusInfo {
    ...
    private static void loadAndLog(Path projectDir) throws Exception {
        ...
        var project = MavenProjectConfigurationLoader.load(projectDir, log);
        log(project, projectDir, log);
    }

    private static void log(ConfiguredProject project, Path projectDir, MessageWriter log) {
