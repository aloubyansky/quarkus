...
import static io.quarkus.devtools.project.state.MavenProjectConfigurationLoader.load;
...
public class WorkspaceQuarkusInfo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        load(Path.of("/home/aloubyansky/git/quarkus-todo-app"));
    ...
    public static void generateUpdateRecipe(Path projectDir) throws Exception {
        ...
        final ConfiguredProject project = load(projectDir, mavenCtx);
