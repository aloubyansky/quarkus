...
public class ExtensionCatalogJsonReader {
     ...
     */
    public static ExtensionCatalog readExtensionCatalog(JsonObject json) {
        return readMutableExtensionCatalog(json).build();
    }
     ...
     */
    public static ExtensionCatalog.Mutable readMutableExtensionCatalog(JsonObject json) {
